      ...
      <div className="flex flex-col items-center">
        <div className="lg:max-w-[770px]">
          ...
          <div className="flex flex-row lg:flex-col lg:w-9/12 lg:text-left">
            <p className="text-dark-blue lg:w-full lg:ml-10 lg:mr-5">
            ...
            <ul className="text-dark-blue lg:max-w-[680px] list-disc lg:w-screen lg:ml-[2vw] lg:mr-[10vw] p-5 lg:p-10 lg:text-left">
              <li>
