const Section = () => {
    return (
        ...
        <div className="max-w-screen-md mx-auto">
            <h2 className="pt-7 font-semibold sm:text-3xl font-space-grotesk lg:text-5xl text-customBlue mb-4 lg:mb-8">
                Решения
            </h2>
            <div className="sm:text-sm pt-2 lg:text-lg text-customBlue mb-4 lg:mb-8">
                <p className="mb-4">
            ...
            <ul className="ml-7 list-disc sm:text-sm lg:text-lg text-customBlue">
                <li className="mb-5">
            ...
            <h2 className="font-semibold font-space-grotesk mt-20 lg:text-5xl text-customBlue mb-4 lg:mb-8">
                Предимства
            </h2>
            <div className="sm:text-sm pt-2 lg:text-lg text-customBlue mb-4 lg:mb-10">
                <p>
                    Фокусът ни върху клиентите е същността на нашата работа. Ние
                    доставяме услуги за всички видове бизнес – от малки местни
