...
const NavBar = () => {
  ...
  const menuContainerClasses = `absolute top-full left-4 right-0 md:relative md:flex justify-center ${
    isOpen ? "block" : "hidden"
    ...
    <nav className="relative z-10 flex flex-col md:flex-row justify-center items-center py-3 px-4 md:px-10">
      ...
      <div className={menuContainerClasses}>
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <Link href="#" className={menuItemClasses}>
            <span className={`${spanClasses} md:mr-4 lg:mr-20`}>Контакти</span>
          </Link>
          <Link href="#" className={menuItemClasses}>
